...
const Blog_Qa = () => {
  return (
    <div className='card w-full bg-base-100 shadow-xl rounded-b-none rounded-t-none p-5'>
      ...
      <p className="pb-1">States are built-in React object which is used to store data or details about the component. Whereas, Props are a Component’s custom attributes which are set so that they could be useful for customization. It modifies a component’s behavior or output, which is the reason it can be used as a parameter to customize the application.</p>
